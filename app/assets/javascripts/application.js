...
$(document).ready(function() {
  mapboxgl.accessToken =
    "pk.eyJ1IjoibWItbWFwYm94IiwiYSI6ImNrMzE0dWlkNTA1aHgzbWxidGIycTFyYnEifQ.tjVyoRPG6zh-KUfGSKrimQ";
  ...
  map.on("load", function(e) {
    ...
    // map.addSource("cts", {
    //   type: "vector",
    //   url: "mapbox://citrusvanilla.8bacl9xx" //For style I think
    // });
    ...
    // Modes control.
    // vizControl.on("click", function() {
    //   changeMode({ id: "viz" });
    // });
    // statsControl.on("click", function() {
    //   changeMode({ id: "stats" });
    // });
    // storyControl.on("click", function() {
    //   changeMode({ id: "story" });
    // });
